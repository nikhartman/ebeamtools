...
def travelling_ebeam_sort(poly_list, timeout = 3):
    """ solve a travelling salesman problem using the 
    ...
    if assignment:
        ...
        route = np.empty(matrix.tsp_size+1) # list to hold route results
        i = 0
...
def typewriter_sort(poly_list, n = SMALLEST_SCALE):
